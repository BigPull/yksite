/**
 * Laufzeit-Seed für den Docker-Container (plain ESM, ohne tsx).
 * Wird vom docker-entrypoint.sh via `node prisma/seed.mjs` aufgerufen und
 * nutzt nur Pakete, die ohnehin im Standalone-Build vorhanden sind
 * (@prisma/client, bcryptjs). Identische, idempotente Logik wie seed.ts.
 */
